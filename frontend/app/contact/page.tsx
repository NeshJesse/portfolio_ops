        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Contact information not found</h3>
              <p className="text-gray-500">
                Please add a <code className="bg-gray-100 px-2 py-1 rounded text-sm">contact.json</code> file to your portfolio data.
              </p>
            </div>
          </div>
        </div>
